...
public class MyAdressplusContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.address.addresses.contentprovider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        // Set the table
        queryBuilder.setTables(AddressTableHandler.TABLE_ADDRESS);
    ...
    private void checkColumns(String[] projection) {
        String[] available = { AddressTableHandler.COLUMN_DESIGNATION,
                AddressTableHandler.COLUMN_FIRSTNAME, AddressTableHandler.COLUMN_LASTNAME,AddressTableHandler.COLUMN_ADDRESS,AddressTableHandler.COLUMN_PROVINCE
